...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\DELL\PycharmProjects\pythonProject_pytest\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\DELL\PycharmProjects\pythonProject_pytest\venv\Scripts\deactivate.nu'
